...
### 方式一：CRX 文件直接拖拽安装（最快）
1. 前往 [Releases 页面](https://github.com/UncleK/SideX/releases) 下载 **`SideX-v1.1.0.crx`**。
2. 打开浏览器扩展管理页面：
...
1. 前往 [Releases 页面](https://github.com/UncleK/SideX/releases) 下载 **`SideX-v1.1.0.zip`** 并解压。

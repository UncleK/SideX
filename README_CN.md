...
在 X (Twitter) 网页端浏览信息流时，每次点击推文看评论都会强行跳页，打断原本的滚动浏览位置。

**SideX** 彻底改变了这一体验——在时间线中点击任意推文时**无需跳页**，右侧第三列就地化身为极简评论抽屉，同时原地展开主帖长文；支持清晰的对话树连接线、二级回复下钻以及行内贴图回复，带来丝滑顺畅的“边刷边看”体验。

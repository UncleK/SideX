...
1. Download **`SideX-v1.0.5.crx`** from [Releases](https://github.com/UncleK/SideX/releases).
...
1. Download **`SideX-v1.0.5.zip`** from [Releases](https://github.com/UncleK/SideX/releases) and extract it.
